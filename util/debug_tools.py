...
# ......................................................................... 
def extract_guppy_distributions(config):
    """ call variants """
    logging.info("-----------------------------------------------")
    logging.info("extract_guppy_distributions")
    logging.info("-----------------------------------------------")
    bam_file = '/Volumes/'+config["bam_file"]
    pos_file = '/Volumes/'+config["pos_file"]
    out_file = '/Volumes/'+config["out_file"]
...
USAGE: debug_tools.py MODE'''
    ...
    parser["extract_guppy_distributions"].add_argument("-c","--config", type=existing_file, required=True, dest="confF", help="JSON config file")
    ...
    if mode == "extract_guppy_distributions":    
        ...
        extract_guppy_distributions(config)
